...
<div class="cell medium-9 medium-cell-block-y">
        ...
        <div class="scroller">
            <ul class="menu simple">
                <li style="padding: 0.7rem 1rem;"><a
                        href="{{root}}galeriak/2021_22/ps/fooldal_2021_22_ps.php">Székhely</a></li>
                <li class="is-active"><a href="{{root}}galeriak/2021_22/bs/fooldal_2021_22_bs.php"
    ...
    <div class="cell">
      <div class="card">';
        ...
        echo '<form action="galeria_2021_22_bs.php" method="post">
          <img src="' . $file . '">
