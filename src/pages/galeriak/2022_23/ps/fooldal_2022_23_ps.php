    ...
    <div class="headers">
      <div class="scroller">
        <ul class="menu simple">
          <li class="is-active"><a href="{{root}}galeriak/2022_23/ps/fooldal_2022_23_ps.php" style="padding: 0.7rem 1rem;">Székhely</a></li>
          <li style="padding: 0.7rem 1rem;"><a href="{{root}}galeriak/2022_23/bs/fooldal_2022_23_bs.php">Tagiskola</a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="cell">
      <div class="card">';
        ...
        foreach (glob($mainDir . '/' . $subDirectory . '/*.jpg') as $file) {
          ...
          echo '<form action="galeria_2022_23_ps.php" method="post">
          <img  src="' . $file . '">
