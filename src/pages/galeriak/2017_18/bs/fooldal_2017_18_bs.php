...
<div class="cell medium-9 medium-cell-block-y">
        ...
        <div class="scroller">
            <ul class="menu simple">
                <li style="padding: 0.7rem 1rem;"><a
                        href="{{root}}galeriak/2017_18/ps/fooldal_2017_18_ps.php">Székhely</a></li>
                <li class="is-active"><a href="{{root}}galeriak/2017_18/bs/fooldal_2017_18_bs.php"
    ...
    <div class="cell">
      <div class="card">';
        ...
        echo '<form action="galeria_2017_18_bs.php" method="post">
          <img src="' . $file . '">
